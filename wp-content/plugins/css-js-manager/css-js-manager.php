 ...
 */
define( 'PLUGIN_CSS_JS_MANAGER', '2.4.17' );
...
function pisol_cjma_plugin_link( $links ) {
	$links = array_merge( array(
        ...
        '<a style="color:#0a9a3e; font-weight:bold;" target="_blank" href="' . esc_url(CSS_JS_MANAGER_BUY_URL) . '">' . __( 'Buy PRO Version','css-js-manager' ) . '</a>'
	), $links );
	return $links;
}
