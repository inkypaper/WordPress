        ...
        <div class="title_page"><?php the_title(); ?></div>
            <div id="loop_director">
                <?php 
                    ...
                    ////////////////////////////////////////////////
                    ////////////////////////////////////////////////    
                    $query = new WP_Query(array( 'post_type' => 'post' , 'posts_per_page' => 1, 'assemblies' => $sel->category_nicename  ));
                ...
                <div class="title-post">
                    <a href="<?php echo get_term_link($sel)?>" title="<?php echo $sel->name; ?>">
                        <span class="count_ser"><?php echo $sel->count; ?> <?php _e( 'فيلم' , 'YourColor' ); ?></span>
