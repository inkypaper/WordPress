WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:39:39
...
Reduction: 2% (went from 179 bytes to 176 bytes)
...
Reduction: 43% (went from 179 bytes to 102 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 564 ms, reducing file size with 43% (went from 179 bytes to 102 bytes)
