WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:40:53
...
Reduction: -79% (went from 2924 bytes to 5242 bytes)
...
Reduction: 12% (went from 2924 bytes to 2562 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 632 ms, reducing file size with 12% (went from 2924 bytes to 2562 bytes)
