WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:40:32
...
Reduction: -73% (went from 1834 bytes to 3170 bytes)
...
Reduction: 14% (went from 1834 bytes to 1580 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 637 ms, reducing file size with 14% (went from 1834 bytes to 1580 bytes)
