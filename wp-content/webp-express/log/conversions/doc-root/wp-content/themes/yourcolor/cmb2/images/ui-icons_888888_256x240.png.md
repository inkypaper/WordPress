WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:38:44
...
Reduction: 31% (went from 5104 bytes to 3516 bytes)
...
Reduction: 34% (went from 5104 bytes to 3370 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 775 ms, reducing file size with 34% (went from 5104 bytes to 3370 bytes)
