WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:38:41
...
Reduction: 15% (went from 4196 bytes to 3582 bytes)
...
Reduction: 20% (went from 4196 bytes to 3370 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 611 ms, reducing file size with 20% (went from 4196 bytes to 3370 bytes)
