WebP Express 0.19.1. Conversion triggered using bulk conversion, 2021-05-18 01:38:24
...
Reduction: 21% (went from 86 bytes to 68 bytes)
...
Reduction: 56% (went from 86 bytes to 38 bytes)

Picking lossless
cwebp succeeded :)

Converted image in 655 ms, reducing file size with 56% (went from 86 bytes to 38 bytes)
